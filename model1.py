...
train_datagen = ImageDataGenerator(
    ...
    brightness_range=[0.8, 1.2]  # Brightness range for light contrast variation
)
...
model = models.Sequential([
    ...
    layers.Dense(512, activation='relu'),  # Increased units in the first dense layer
    layers.BatchNormalization(),
    layers.Dropout(0.5),
    layers.Dense(256, activation='relu'),  # Increased units in the second dense layer
    layers.BatchNormalization(),
    layers.Dropout(0.5),
